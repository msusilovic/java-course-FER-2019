...
public class SmartScriptParser {
	...
	private void parse(Lexer lexer) {
		...
		stack = new Stack<>(); //temporary structure to help generate a tree of objects
		...
		while (!(last = lexer.nextToken()).getType().equals(TokenType.EOF)) {
			...
			if (last.getType().equals(TokenType.TAG_START)) {
				...
				// case tag name is FOR
					...
					ArrayList<Element> helpCollection = new ArrayList<>();
					int index = 0;
	 ...
	 */
	private void checkNumberOfElementsForLoop(ArrayList<Element> helpCollection) {
	 ...
	 */
	private void checkIfOkForLoopNodeAndAdd(Token last, ArrayList<Element> helpCollection, int index) {
		if (index == 0) {
	 ...
	 */
	private void checkType(Token last, ArrayList<Element> tempCollection) {
	 ...
	 * @param index	
	 */
	private void checkIfOkForEchoNodeAndAdd(Token last, ArrayList<Element> tempCollection) {

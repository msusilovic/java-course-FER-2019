...
public class ArrayIndexedCollection<T> implements List<T> {
	...
	public ArrayIndexedCollection(int initialCapacity) {
		if (initialCapacity < 1) {
			throw new IllegalArgumentException("Illegal initial capacity provided:" + initialCapacity);
		}
	...
	public ElementsGetter<T> createElementsGetter() {
		return new ElementsGetterForArray<T>(this);
	 ...
	 *
	 */
	private static class  ElementsGetterForArray<T> implements ElementsGetter<T> {
		 ...
		 */
		public ElementsGetterForArray (ArrayIndexedCollection<T> collection) {

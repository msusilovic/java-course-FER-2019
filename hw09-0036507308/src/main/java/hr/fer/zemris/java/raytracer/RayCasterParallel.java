...
public class RayCasterParallel {
	...
	private static IRayTracerProducer getIRayTracerProducer() {
		...
		return new IRayTracerProducer() {
			...
			/**
			 * This implementation of a method distributes jobs to be done between multiple threads 
			 * by splitting pixels of a plane to be checked into groups by lines. For this 
			 * distribution a ForkJoinPool is being used.
			 */
			@Override
			public void produce(Point3D eye, Point3D view, Point3D viewUp, double horizontal, double vertical,
				...
				Job j = new Job(screenCorner, width, height, vertical, horizontal, rgb,
						red, blue, green, zAxis, yAxis, xAxis, scene, eye, 0, height);
				pool.invoke(j);
